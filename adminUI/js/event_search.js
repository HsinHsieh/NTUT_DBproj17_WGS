$(document).ready(function() {
  ...
  $('#event_delete_submit').click(function() {
    ...
    $('#eventDeleteModal').on('hide.bs.modal', function(event) {
      eventFetch();
    });
  });
});